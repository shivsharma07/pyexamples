...
WORDLIST_FILENAME = "F:/Workspaces/PyDev/edx6.0.1x/ps4/words.txt"
...
def updateHand(hand, word):
    ...
    for letter in word:
        if handNew[letter] > 0:
            handNew[letter] = handNew.get(letter, 0)-1
    return handNew
    ...
    if word in wordList:
        for letter in word:
           if word.count(letter) > hand.get(letter, 0):
               #print getFrequencyDict(word) // Compare 2 dictionaries
               return False
        return True
    return False

#print getFrequencyDict("apple")
#
...
def playGame(wordList):
    ...
    while userInput != "e":
        if userInput == "r":
            ...
            result = playHand(currentHand, wordList, HAND_SIZE)
